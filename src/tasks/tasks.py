...
def delete_task(id):
    ...
    try:
        ...
        if not persistence.set_expire_task(r,tasks[hash_id].get_internal_status(),secs=300):
...
def expire_task(id):
    ...
    try:
        ...
        if not persistence.set_expire_task(r,tasks[hash_id].get_internal_status(),secs=exp_time):
